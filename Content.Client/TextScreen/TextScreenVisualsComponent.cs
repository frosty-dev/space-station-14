...
namespace Content.Client.TextScreen
{
    ...
    public sealed class TextScreenVisualsComponent : Component
    {
        ...
        /// </summary>
        [DataField("currentMode")] public TextScreenMode CurrentMode = TextScreenMode.Text;
        /// <summary>
        ...
        /// </summary>
        [DataField("textLength")] public int TextLength = 5;
        ...
        /// </summary>
        [DataField("layerStatesToDraw")] public Dictionary<string, string?> LayerStatesToDraw = new();
    }
}
