...
public sealed class DoAfterQTEOverlay : Overlay
{
    ...
    public DoAfterQTEOverlay(IEntityManager entManager, IPrototypeManager protoManager, IResourceCache cache)
    {
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        foreach (var comp in _entManager.EntityQuery<DoAfterQTEComponent>(true))
        {
            ...
            foreach (var (_, doAfter) in comp.DoAfters)
            {
                ...
                var xProgress = lengthX * displayRatio + startX;
