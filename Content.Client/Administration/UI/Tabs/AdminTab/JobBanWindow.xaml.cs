...
namespace Content.Client.Administration.UI.Tabs.AdminTab
{
    ...
    public sealed partial class JobBanWindow : DefaultWindow
    {
        ...
        private bool DepartmentSelected = false;
        ...
        {
            SubmitButton.Disabled = string.IsNullOrEmpty(RoleNameLine.Text);
        }
        ...
        private void SubmitButtonOnPressed(BaseButton.ButtonEventArgs obj)
        {
            ...
            else
            {
                ...
                IoCManager.Resolve<IClientConsoleHost>().ExecuteCommand(
                    $"roleban \"{PlayerNameLine.Text}\" \"{Job  NameLine.Text}\" \"{CommandParsing.Escape(ReasonLine.Text)}\" {MinutesLine.Text}");
            }
        }
    }
}
