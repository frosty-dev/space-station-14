...
ui-options-hud-theme-modernized = Obsolete
ui-options-hud-theme-classic = Default
ui-options-obsolete-interface-warning = "WARNING: You are using an outdated version of the interface!"
